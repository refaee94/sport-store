...
namespace SportsStore.Models
{
    ...
    public static class IdentitySeedData
    {
        ...
        private const string adminPassword = "123580@Aa";
        private const string adminRole = "Administrator";
        public static async void SeedDataBaseAsync(IApplicationBuilder app)
        {
    //   (GetAppService<IdentityStoreAppContext>(app)).Database.Migrate();
